pipeline {
    ...
    stages {
          ...
          stage("Deploy to Staging and perform code analysis") {
			...
			stage("Deploy to staging") {
				steps {
				   deploy adapters: [tomcat8(credentialsId: 'd4098cd1-4505-4831-b36c-1a745b07eadb', path: '', url: 'http://ec2-3-129-149-119.us-east-2.compute.amazonaws.com:9090/')], contextPath: null, onFailure: false, war: '**/*.war'
				}
				post {
				    success {
	...
	stage("Deploy to production") {
		steps {
			...
			deploy adapters: [tomcat8(credentialsId: 'd4098cd1-4505-4831-b36c-1a745b07eadb', path: '', url: 'http://ec2-3-129-149-119.us-east-2.compute.amazonaws.com:9999/')], contextPath: null, onFailure: false, war: '**/*.war'
		}
		post {
			success {
